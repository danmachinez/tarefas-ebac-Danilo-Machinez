package br.edu.danmach;

import br.edu.danmach.dao.IClienteDAO;
import br.edu.danmach.dao.ClienteMapDAO;
    ...
    public static void main(String[] args) {
        ...
        while (isOpcaoValida(opcao)) {
            ...
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null,
                        "Digite os dados do cliente separados por virgula, conforme exemplo: Nome, Cpf, Telefone, Endereco, Numero, Cidade, Estado",
